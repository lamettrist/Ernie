...
console.log(await john.run('Hi Ernie! Could you please help me with conducting a literature review to understand the limitations of LLM-derived agents? Thank you!'))
